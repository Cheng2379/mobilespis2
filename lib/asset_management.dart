...
class _AssetManagementState extends State<AssetManagement> {
                              ...
                              Align(
                                ...
                                child: Container(
                                    ...
                                    child: Container(
                                      ...
                                      child: Image.asset(
                                          "images/${assetList[index]["assetPhotos"].length > 0 ?
                                          assetList[index]["assetPhotos"][0]["photo"]
                                              :
                                          "image_null.png"}",
                                          fit: BoxFit.fill),
                                    )),
                ...
                child: Container(
                  ...
                  child:  Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        border: Border.all(width: 2,color: Color(0xff8A8A8A))
                    ),
                    ...
                    child: MaterialButton(
                      ...
                      child: Icon(Icons.add,size: ScreenUtil().setSp(22),)
                    ),
                  )
                )
            ),
  ...
  void _search(){
    Navigator.push(context, MaterialPageRoute(
      builder: (context) => SearchAsset()
    ));
  }
  //账户
  void _asset(){
    Navigator.of(context).push(MaterialPageRoute(
        builder: (context) =>MyCenter()
    ));
  }
  //注册
  void _add(){
