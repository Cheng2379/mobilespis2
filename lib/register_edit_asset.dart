// ignore_for_file: prefer_const_constructors, avoid_unnecessary_containers, slash_for_doc_comments, prefer_const_literals_to_create_immutables, sized_box_for_whitespace, unnecessary_null_comparison, prefer_final_fields, unused_import
...
class _RegisterEditAssetState extends State<RegisterEditAsset> {
  ...
  void initState() {
    ...
    // WidgetsBinding.instance!.addPostFrameCallback((_) => getAsset());// Build方法执行之后调用
  }
